module Waves
  ...
  #
  # Controller methods simply return data (a resource), if necessary, tha
  ...
  #         end
  #
  #         # Find and delete - or will raise a 404 if it doesn't exis
  ...
  # don't have to be at all concerned with views. They don't have to se
  ...
  module Controllers
    ...
    # want to include it in any controllers you define for your application. The defaul
    ...
    module Mixin
      ...
      # The params variable is taken from the request object and "destructured", so tha
