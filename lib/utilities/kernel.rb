module Kernel
  ...
  #
  # Inspired by a question on comp.lang.ruby. Sort of like returning, excep
  ...
  # scope. You can work around this by assigning values to variables, but in tha
  ...
  def with( object, &block )
    object.instance_eval(&block); objec
  end
