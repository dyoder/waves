module Waves
  ...
  module Configurations
    ...
    class Base
      ...
      # Set the given attribute with the given value. Typically, you wouldn'
      # use this directly.
      def self.[]=( name, val )
        meta_def("_#{name}") { val }
      end

      # Get the value of the given attribute. Typically, you wouldn'
      # use this directly.
